...
const val FRAGMENT_TRANSITION_ANIMATION = true
...
fun BottomNavigationView.setupWithNavController(
    ...
    containerId: Int,
    intent: Intent,
    selectedMenuItem: (menuItem: MenuItem) -> Unit
    ...
    navGraphIds.forEachIndexed { index, navGraphId ->
        ...
        // Save to the map
        if (graphIdToTagMap.containsKey(graphId).not()) {
            ...
            if (selectedItemTag != newlySelectedItemTag) {
                ...
                if (firstFragmentTag != newlySelectedItemTag) {
                    ...
                    fragmentManager.beginTransaction()
                        .apply {
                            if (FRAGMENT_TRANSITION_ANIMATION) {
                                setCustomAnimations(
    ...
    fragmentManager.addOnBackStackChangedListener {
        if (!isOnFirstFragment &&
            !fragmentManager.isOnBackStack(firstFragmentTag)
        ) {
